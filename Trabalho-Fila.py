...
while True:
    ...
    if dele == '0':
        ...
        if l > 0:
            print('Número %d foi removido da fila dos idosos '%(filaum[0]))
            del(filaum[0])
        else:
            if f > 0:
                print('Número %d foi removido da fila das gestantes '%(filadois[0]))
                del(filadois[0])
            else:
                if p > 0:
                    print('Número %d foi removido da fila dos cidadãs comuns'%(filatres[0]))
                    del(filatres[0])
                else:
                    print()
    ...
    print()
    if senha == '1':
        num1 = int(input('Digite um número que ira te representar na fila: '))
        filaum.append(num1)
    elif senha == '2':
        num2 = int(input('Digite um número que ira te representar na fila: '))
        filadois.append(num2)
    elif senha == '3':
        num3 = int(input('Digite um número que ira te representar na fila: '))
